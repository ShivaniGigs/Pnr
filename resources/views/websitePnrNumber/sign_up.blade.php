...
@endif
<form  id="pnr_form"action="{{route('user_Store')}}" method="post">
    @csrf
    <input type="hidden" id="send-otp-url" value="{{route('send-otp')}}" />
    <input type="hidden" id="verify-otp-url" value="{{route('verify-otp')}}" />
    <input type="hidden" id="csrf_token" value="{{ csrf_token() }}" />
    <label for="name"><b>name</b></label>
    <input type="text" placeholder="Enter name" name="name" id="name" class="form-control required" ><br>
    
    <label for="mobile"><b>mobile</b></label>
    <input type="text" placeholder="Enter mobile" name="mobile" id="mobile" class="form-control required"><br>
    <span id="error_mobile"></span>
    <label for="email"><b>Email</b></label>
    <input type="text" placeholder="Enter Email" name="email" id="email" class="form-control required" ><br>
    <span id="error_email"></span>
    <label for="pincode"><b>pincode</b></label>
    <input type="text" placeholder="Enter pincoder" name="pincode" id="pincode" class="form-control required"><br>
    
    <label for="email"><b>city</b></label>
    <input type="text" placeholder="Enter city" name="city" id="city" class="form-control required" ><br>
    <input type="hidden" placeholder="Enter city" name="state" id="state" class="form-control required" ><br>
